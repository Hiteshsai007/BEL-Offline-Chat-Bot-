...
if (-not (Test-Path $VenvPath)) {
    Write-Host "[1/5] Creating virtual environment at .venv ..." -ForegroundColor Yellow
...
Write-Host "[2/5] Setting offline environment flags ..." -ForegroundColor Yellow
...
Write-Host "[4/5] Downloading BGE embedding model (BAAI/bge-small-en-v1.5) ..." -ForegroundColor Yellow
